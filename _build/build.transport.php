...
$builder->registerNamespace('commerce_addressmanager',false,true,'{core_path}components/commerce_addressmanager/');

/* create category */
$category= $modx->newObject('modCategory');
$category->set('id', 1);
$category->set('category','Commerce_AddressManager');
